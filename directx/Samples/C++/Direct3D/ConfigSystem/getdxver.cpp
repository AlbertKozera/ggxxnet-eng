...
HRESULT GetDirectXVersionViaDxDiag( DWORD* pdwDirectXVersionMajor, DWORD* pdwDirectXVersionMinor, WCHAR* pcDirectXVersionLetter );
HRESULT GetDirectXVerionViaFileVersions( DWORD* pdwDirectXVersionMajor, DWORD* pdwDirectXVersionMinor, WCHAR* pcDirectXVersionLetter );
...
HRESULT GetDXVersion( DWORD* pdwDirectXVersionMajor, DWORD* pdwDirectXVersionMinor, WCHAR* pcDirectXVersionLetter )
{
    ...
    *pcDirectXVersionLetter = ' ';
    ...
    if( SUCCEEDED( GetDirectXVersionViaDxDiag( pdwDirectXVersionMajor, pdwDirectXVersionMinor, pcDirectXVersionLetter ) ) )
    ...
    if( !bGotDirectXVersion )
    {
        ...
        if( SUCCEEDED( GetDirectXVerionViaFileVersions( pdwDirectXVersionMajor, pdwDirectXVersionMinor, pcDirectXVersionLetter ) ) )
            bGotDirectXVersion = true;
    }
